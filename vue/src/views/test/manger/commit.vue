...
<!--    <el-main>
      <el-form :model="requestForm" :rules="requestRules" ref="ruleForm" label-width="100px" >
        ...
        <el-form-item>
          &lt;!&ndash;<el-button type="primary" @click="onSubmit">{{testAction=='ADD'?'立即添加':'修改提测'}}</el-button>&ndash;&gt;
    ...
    <el-main>
      <el-form :model="requestForm" :rules="requestRules" ref="ruleForm" label-width="100px" >
        <el-form-item v-if="testAction==='UPDATE'" label="学号" prop="id">
          <el-input v-model="requestForm.id" style="width: 350px" disabled=""></el-input>
        </el-form-item>
        <el-form-item label="学号" prop="title">
          <el-input v-model="requestForm.title" placeholder="请输入学号" style="width: 350px"></el-input>
        </el-form-item>
        <el-form-item label="姓名" prop="appId">
          <el-select
            v-model="requestForm.appId"
            filterable
            remote
        ...
        <el-form-item label="实验编号" prop="developer">
          <el-input v-model="requestForm.developer" placeholder="请输入实验编号" style="width: 350px"></el-input>
        </el-form-item>
        <el-form-item label="实验名称" prop="tester">
          <el-input v-model="requestForm.tester" placeholder="请输入实验名称" style="width: 350px"></el-input>
        </el-form-item>
        <el-form-item label="实验内容" prop="CcMail">
          <el-input v-model="requestForm.CcMail" placeholder="请输入实验内容 " style="width: 350px"></el-input>
        </el-form-item>
        <el-form-item label="实验说明" prop="version">
          <el-input v-model="requestForm.version" placeholder="请输入实验说明 " style="width: 350px"></el-input>
        </el-form-item>
        <el-form-item label="代码文件类型" prop="type">
          <el-select v-model="requestForm.type" clearable placeholder="请选择..." style="width: 300px">
            <el-option
              v-for="item in opsType"
              :key="item.value"
        ...
        <el-form-item label="代码地址" prop="gitCode">
          <el-input v-model="requestForm.gitCode" placeholder="git代码地址（可空）" style="width: 350px"></el-input>
        </el-form-item>
        <el-form-item label="备注" prop="more">
          <el-input v-model="requestForm.more" type="textarea" :rows="3" placeholder="其他补充信息" style="width: 350px"></el-input>
        </el-form-item>
        <el-form-item>
          <el-checkbox v-model="requestForm.isEmail" true-label="true">代码提交至服务器测试</el-checkbox>
        </el-form-item>
        <el-form-item>
          <!--<el-button type="primary" @click="onSubmit">{{testAction=='ADD'?'立即添加':'修改提测'}}</el-button>-->
          <el-button v-if="testAction==='ADD'" type="primary" @click="onSubmit">立即提交</el-button>
          <el-button v-if="testAction==='UPDATE'" type="primary" @click="onSubmit">修改提测</el-button>
          <el-button @click="onCancel">取   消</el-button>
        </el-form-item>
      </el-form>
